-- Add job title search filter to job applications
-- This migration updates the filtering functions to support job title search
...
GRANT EXECUTE ON FUNCTION get_job_applications_count(UUID, user_role, UUID, UUID, TIMESTAMP WITH TIME ZONE, TIMESTAMP WITH TIME ZONE, TEXT, application_status, TEXT, TEXT) TO authenticated;
